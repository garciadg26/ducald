...
<body>
    ...
    <section id="sec_for_product" class="sec_pintura_producto">
        <div class="cont_encabezado text-center">
            <h2 class="tit_principal_bk home__photo1">Tintas</h2>
            <h4 class="subtit_principal home__photo2">Tintas a base de colorantes disueltos en solvente de rápido secado. Listas para aplicarse en superficies de madera, uso exclusivo en interiores.</h4>
        </div>
        <div class="mt-5">
            <div class="row text-center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <article class="article_product_cover home__photo3">
                        <img src="Public/images/Pinturas-ducald-tintas.png" alt="Pinturas Ducald pasta Acrílica">
                        <h6 class="subtit_principal">Tintas al Alcohol</h6>
