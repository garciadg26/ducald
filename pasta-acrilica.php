    <?php 
        $title = "Pasta acrilica | Pinturas DUCALD";
...
<body>
    ...
    <section id="sec_for_product" class="sec_pintura_producto">
        <div class="cont_encabezado text-center">
            <h2 class="tit_principal_bk home__photo1">Pasta Acrílica</h2>
            <h4 class="subtit_principal home__photo2">Listo para usarse. Ideal para cambiar la decoración de las paredes del exterior. Puede brindar una apariencia rústica debido a su textura rugosa.</h4>
        </div>
        <div class="mt-5">
            <div class="row text-center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <article class="article_product_cover home__photo3">
                        <img src="Public/images/Pinturas-ducald-pasta-acrilica.png" alt="Pinturas Ducald pasta Acrílica">
                        <h6 class="subtit_principal">Pasta Acrílica para Texturizado</h6>
