...
<body>
    ...
    <section id="sec_for_product" class="sec_pintura_producto">
        <div class="cont_encabezado text-center">
            <h2 class="tit_principal_bk home__photo1">Epóxico</h2>
            <h4 class="subtit_principal home__photo2">La mejor solución con acabado satinado para pisos interiores y exteriores. <br>
                Recubrimientos de alta resistencia.</h4>
            <h4 class="subtit_principal mt-5 home__photo1">Disponibles en presentaciones de 4 lts, 19 lts.</h4>
        </div>
        <div class="mt-5">
            <div class="row text-center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <article class="article_product_cover home__photo1">
                        <img src="Public/images/Pinturas-ducald-epoxica.png" alt="Pinturas Ducald Epóxica">
                        <h6 class="subtit_principal">Pintura Epóxica</h6>
