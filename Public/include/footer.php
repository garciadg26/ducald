    <footer id="footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <h6 class="tit_footer">Pinturas Ducald S.A. De C.V. <br>
                        Calle 7 #2 <br>
                ...
                <div class="col-md-3">
                    <ul class="list_foot_product">
                        ...
                        <a href="contacto.php" class="item_list_footer">
                ...
                <div class="col-md-3">
                    <h2 class="tit_foot_principal">ATENCIÓN AL CLIENTE</h2>
                    <ul class="list_foot_product">
                        <a href="tel:3515122297" class="item_list_footer">
                            <li>351 512 22 97</li>
                        </a>
                        <a href="tel:3515127155" class="item_list_footer">
                            <li>351 512 71 55</li>
                        </a>
                        <a href="tel:3515206113" class="item_list_footer">
                            <li>351 520 61 13</li>
                        </a>
                    </ul>
                    <ul class="list_foot_product">
                        <a href="faqs.php" class="item_list_footer">
            ...
            <div class="legales text-center">
                <p class="txt_legales">©2023 Todos los derechos reservados | Diseño por El Trabuco | Desarrollo por Tipos Libres</p>
            </div>
        </div>
    </footer>
