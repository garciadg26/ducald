...
<body>
    ...
    <section id="head_nosotros" class="sec_head_img">
        <img class="img-fluid" src="Public/images/Pinturas-ducald-head_nosotros.jpg" alt="">
    </section>
            ...
            <div class="row">
                ...
                <div class="col-md-4 home__photo4">
                    <p class="txt_general">
                        ...
                        Ducald lleva en su nombre las buenas costumbres, trabajo, lucha, unidad y humildad, por eso es: De Unión CALDerón.
                    </p>
                </div>
            </div>
        </div>
    ...
    <!-- TECONOLÍA -->
    <section id="sec_tecnologia" class="">
        <div class="slide-img owl-carousel owl-theme">
            <div class="item item_img_01">
                <img class="img-fluid" src="Public/images/Slider-nosotros_001.jpg" alt="">
            </div>
            <div class="item item_img_02">
                <img class="img-fluid" src="Public/images/Slider-nosotros_001.jpg" alt="">
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-md-6 home__photo1">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h4 class="subtit_tercero">CALIDAD</h4>
                        <p class="txt_general">Mantener una mejora continua, aumentando los estándares de calidad en todos nuestros productos, superando las expectativas de nuestros clientes y colaboradores.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 home__photo3">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h4 class="subtit_tercero">RESPONSABILIDAD</h4>
                        <p class="txt_general">Respetar los acuerdos en el cumplimiento de nuestras actividades en beneficio de los clientes y de nosotros como empresa.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 home__photo1">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h4 class="subtit_tercero">VARIEDAD</h4>
                        <p class="txt_general">Contar con vasta gama de productos que satisfagan en todo momento la demanda de nuestros clientes.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 home__photo3">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h4 class="subtit_tercero">EXPERIENCIA</h4>
                        <p class="txt_general">Contar con personal altamente calificado en la fabricación y comercialización de nuestros productos.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 home__photo1">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h4 class="subtit_tercero">SERVICIO</h4>
                        <p class="txt_general">Brindar atención personalizada de calidad a todos nuestros clientes actuales y potenciales.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 home__photo3">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h4 class="subtit_tercero">HONRADEZ</h4>
                        <p class="txt_general">Ofrecer productos que garanticen su calidad y confiablidad.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 home__photo1">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h4 class="subtit_tercero">ECOLOGÍA</h4>
                        <p class="txt_general">Fomentar el interés de conservar y mantener nuestro entorno libre de contaminantes.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 home__photo3">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <h4 class="subtit_tercero">MEDIO AMBIENTE</h4>
                        <p class="txt_general">Contribuir con la elaboración de productos amigables con el medio ambiente.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- ESTAMOS CERCA DE TI -->
    <section id="sec_directorio" class="sec_gen pleca_divider pleca_blue">
        <h2 class="tit_principal_bn text-center">ESTAMOS CERCA DE TI</h2>
        ...
        <div class="container">
            <h6 class="subtit_principal_bn text-center mt-5">Contamos con rutas de distribución que nos permiten estar en constante crecimiento.</h6>
        </div>
    </section>
