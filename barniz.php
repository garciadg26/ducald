...
<body>
    ...
    <section id="sec_for_product" class="sec_pintura_producto">
        <div class="cont_encabezado text-center">
            <h2 class="tit_principal_bk">Barniz</h2>
            <h4 class="subtit_principal">Embellece y resalta el veteado natural de la madera, protegiéndola contra los agentes externos y cambios de temperatura y humedad.</h4>
        </div>
        <div class="mt-5">
