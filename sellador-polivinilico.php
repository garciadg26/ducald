    <?php 
        $title = "Sellador Polivinílico | Pinturas DUCALD";
...
<body>
    ...
    <section id="sec_for_product" class="sec_pintura_producto">
        <div class="cont_encabezado text-center">
            <h2 class="tit_principal_bk home__photo1">Sellador Poliviníloco</h2>
            <h4 class="subtit_principal home__photo2">Sella porosidades de nuevos muros y repintados de yeso, cemento y concreto. Excelente opción como consolidante de paredes porosas o arenosas, para proteger de la humedad.</h4>
            <h4 class="subtit_principal mt-5 home__photo3">Disponibles en presentaciones de 4 lts, 19 lts.</h4>
        </div>
        <div class="mt-5">
            <div class="row text-center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <article class="article_product_cover home__photo4">
                        <img src="Public/images/Pinturas-ducald-acetato-de-polivinilo.png" alt="Pinturas Ducald Acetato de Polivinilo">
                        <h6 class="subtit_principal">Acetato de polivinilo</h6>
